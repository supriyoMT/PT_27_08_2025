...
INSERT INTO `courses` VALUES (1,'Python','Biren'),(2,'AIML','Charlie'),(3,'Web','John');
...
CREATE TABLE `feedback` (
  ...
  CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`courseid`) REFERENCES `courses` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-01 17:55:05
